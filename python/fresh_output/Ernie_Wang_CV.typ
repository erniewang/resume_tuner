...
#set page(
  margin: (
    top: design-page-top-margin * 0.3,
    bottom: design-page-bottom-margin * 0.3,
    left: design-page-left-margin * 0.3,
    right: design-page-right-margin * 0.3,
  ),
...
#set par(
  spacing: 0pt,
  leading: design-text-leading * 0.7,
  justify: justify,
)
#set enum(
...
#let highlights(..content) = {
  list(
    ...
    spacing: design-highlights-vertical-space-between-highlights * 0.6,
...
#show heading.where(level: 2): it => [
  ...
  #v(design-section-titles-vertical-space-above * 0.6, weak: true)
  #block(
    breakable: false,
    width: 100%,
    [
  ...
  #v(design-section-titles-vertical-space-below * 0.4 - 0.3em)
]
...
#one-col-entry(
  content: [Languages: #emph[Python], #emph[JavaScript], #emph[TypeScript], #emph[C++], #emph[Racket], #emph[Java], #emph[Go]]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [Frameworks\/Tools: #emph[Git], #emph[Linux], #emph[XML], #emph[Flask], #emph[FastAPI], #emph[BeautifulSoup], #emph[NumPy], #emph[Pydantic], #emph[Pandas], #emph[Supabase], #emph[React], #emph[AWS], #emph[Node], #emph[MySQL], #emph[SQLite], #emph[NextJS], #emph[Tailwind], #emph[Electron], #emph[Puppeteer]]
)
#v(design-entries-vertical-space-between-entries)
#one-col-entry(
  content: [Other: #emph[Finale], #emph[Logic Pro X], #emph[Adobe Photoshop], #emph[Final Cut Pro X], #emph[Musescore]]
)
...
#two-col-entry(
  left-content: [
    #strong[Northwestern University], Computer Vision Developer
  ],
  right-content: [
    Mar 2025 – June 2025
  ],
...
#one-col-entry(
  content: [
    #v(design-highlights-top-margin);#highlights([Performed with Northwestern University Jazz Orchestra \(2020–2024\) and in a variety of university bands, featuring both live and virtual gigs.],[Utilized AI music generation tools \(Musicfy, Udio\) alongside custom scripts to explore digital composition and arrangement.],[Conducted private lessons, teaching saxophone\/clarinet fundamentals and improvisational listening skills to a broad range of students.],[Skills: Performance, Jazz Improvisation, AI Music Tools, Teaching],)
  ],
)
